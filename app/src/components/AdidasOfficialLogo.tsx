...
interface AdidasOfficialLogoProps {
    /** Custom className for sizing and styling */
    className?: string;
    /** Fill color for the stripes (defaults to currentColor) */
    stripeColor?: string;
    /** Fill color for the text (defaults to currentColor) */
    textColor?: string;
    /** Overall fill color (overrides both stripe and text colors if provided) */
    fillColor?: string;
    /** Accessibility label */
    'aria-label'?: string;
}

const AdidasOfficialLogo: React.FC<AdidasOfficialLogoProps> = ({
    className,
    stripeColor,
    textColor,
    fillColor,
    'aria-label': ariaLabel = 'Adidas Logo',
    ...props
}) => {
    // Determine final colors
    const finalStripeColor = fillColor || stripeColor || 'currentColor';
    const finalTextColor = fillColor || textColor || 'currentColor';
...
export default AdidasOfficialLogo;
