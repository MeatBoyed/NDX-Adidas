                        ...
                        <Card className="glossy-white text-black border-0 shadow-2xl card-glow relative overflow-hidden">
                            ...
                            <CardContent className="text-center space-y-6 relative z-10">
                                ...
                                {prize.isWin && prize.voucherCode && (
                                    ...
                                    >
                                        <p className="text-white text-sm font-medium mb-3">Your Voucher Code:</p>
                                        <div className="bg-white text-black px-6 py-4 rounded font-mono text-xl tracking-wider font-bold">
                                            {prize.voucherCode}
                                        </div>
                                ...
                                {prize.isWin && (
                                    <motion.p
                                        ...
                                        transition={{ delay: 1 }}
                                    >
                                        ✨ Thank you for being part of AdiClub! Check your email for more exclusive offers.
                                    </motion.p>
                                )}
                            </CardContent>
                        </Card>
